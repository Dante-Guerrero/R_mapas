...
mx <- st_read("insumos/demarcacion/pais/geo.shp")
...
mx <- st_read("insumos/demarcacion/departamentos/geo.shp")
...
mx <- st_read("insumos/demarcacion/provincias/geo.shp")
...
mx <- st_read("insumos/demarcacion/distritos/geo.shp")
